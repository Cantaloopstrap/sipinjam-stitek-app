...
import { LayoutDashboard, Building2, Package, PlusCircle, CalendarDays, User, History, Users, CheckSquare, FileText, Settings, LogOut, GraduationCap } from 'lucide-react'
...
export function AppSidebar({ ...props }: React.ComponentProps<typeof Sidebar>) {
  ...
  return (
    <Sidebar collapsible="icon" className="sidebar-blur border-r" {...props}>
      <SidebarHeader>
        <SidebarMenu>
          <SidebarMenuItem>
